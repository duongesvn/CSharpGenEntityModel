...
{
    public partial class BomworkOrderRouting
    {
        public BomworkOrderRouting()
        {
            BomcamSheets = new HashSet<BomcamSheet>();
        }
        ...
        public virtual ICollection<BomcamSheet> BomcamSheets { get; set; }
    }
}
